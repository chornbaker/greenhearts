          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
                ...
                <span className="text-xs text-gray-800">Add Plants</span>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
                ...
                <span className="text-xs text-gray-800">Track Care</span>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
                ...
                <span className="text-xs text-gray-800">Get Reminders</span>
              </div>
            </div>
            
            <div className="flex items-center justify-between bg-green-100 rounded-full p-1 mb-6">
              <button className="flex-1 py-2 px-4 text-center text-gray-800 text-sm">
                Get Started
              </button>
              <Link 
                href="/login" 
                className="flex-1 bg-green-700 text-white py-2 px-4 rounded-full text-center text-sm flex items-center justify-center gap-2"
              >
